...
public class DatabaseController {
    ...
    public void initAdminData() {
        ...
        if(!userRepos.existsByUsername("duyle")){
            ...
            Employee adminEmployee = employeeRepos.save(new Employee(null, "ed9a1111-1d0d-49d2-9d31-185c7d2c8167", "Duy", "Lê Bá", Gender.Male, new Date("1990/05/25"), "administrator@mediap.com", "361-218-1685", null, "https://randomuser.me/api/portraits/men/62.jpg", adminAddress, false, EmployeeRole.ADMIN, true, 10, new Date(), adminUser, true));
        }
        ...
        if(!userRepos.existsByUsername("khoale")) {
            ...
            Patient patient = patientRepos.save(new Patient(null, "ed9a5502-267d-49d2-9d31-156c7d2t8167", "Khoa", "Lê Quốc Anh", Gender.Male, new Date("1987/ 04/ 23"), "khoa.le@gmail.com", "567-167-6784", null, "https://randomuser.me/api/portraits/men/65.jpg", patientAddress, false, patientUser, null, true));
        }
        ...
        if(!userRepos.existsByUsername("bachnguyen")) {
            ...
            Patient patient = patientRepos.save(new Patient(null, "f5fffa8f-2f80-4250-8bd4-76t982f5b48c", "Bạch", "Nguyễn Thanh", Gender.Male, new Date("1997/04/23"), "bach.nguyen@gmail.com", "675-890-3674", null, "https://randomuser.me/api/portraits/men/63.jpg", patientAddress, false, patientUser, null, true));
        }
