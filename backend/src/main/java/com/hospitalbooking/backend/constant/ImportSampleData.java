    ...
    public static void importAll(AddressRepos addressRepos, UserRepos userRepos, DoctorRepos doctorRepos, PatientRepos patientRepos, EmployeeRepos employeeRepos, DoctorScheduleRepos doctorScheduleRepos, PasswordEncoder encoder){
        {
            if(!userRepos.existsByUsername("patientuser0")) {
                ...
                patientRepos.save(new Patient(null, "7932a001-0290-4681-8bd8-75cccef31599", "Julianne", "Myrdal", "Female", new Date("1977/10/04"), "patient.julianne.myrdal@example.com", "48086815", null, "https://randomuser.me/api/portraits/women/91.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser1")) {
                ...
                patientRepos.save(new Patient(null, "ed9a5502-1d0d-49d2-9d31-185c7d2c8167", "Jaroslav", "Hierl", "Male", new Date("1985/07/24"), "patient.jaroslav.hierl@example.com", "0175-7374265", null, "https://randomuser.me/api/portraits/men/26.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser2")) {
                ...
                patientRepos.save(new Patient(null, "e2eefa8f-4f80-4250-8bd4-76a982f5b48c", "Thomas", "Ambrose", "Male", new Date("1950/04/26"), "patient.thomas.ambrose@example.com", "Y45 T29-1990", null, "https://randomuser.me/api/portraits/men/11.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser3")) {
                ...
                patientRepos.save(new Patient(null, "64993167-3d09-42e1-8ef3-4cc4f497f5c8", "Moritz", "Griese", "Male", new Date("1950/06/18"), "patient.moritz.griese@example.com", "0174-7019689", null, "https://randomuser.me/api/portraits/men/69.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser4")) {
                ...
                patientRepos.save(new Patient(null, "2b48f1d1-87db-4ad4-ab3f-78b4f2fe0b49", "Martyna", "Trøan", "Female", new Date("1972/09/28"), "patient.martyna.troan@example.com", "46123127", null, "https://randomuser.me/api/portraits/women/71.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser5")) {
                ...
                patientRepos.save(new Patient(null, "9d5f72bc-f271-46f5-a2fe-2265fbd64c22", "Théodore", "Girard", "Male", new Date("1953/12/12"), "patient.theodore.girard@example.com", "06-93-26-21-97", null, "https://randomuser.me/api/portraits/men/87.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser6")) {
                ...
                patientRepos.save(new Patient(null, "aa0a7b45-65e7-498c-9515-2a3d138236fb", "Carolyn", "Gregory", "Female", new Date("1946/11/02"), "patient.carolyn.gregory@example.com", "0415-158-077", null, "https://randomuser.me/api/portraits/women/43.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser7")) {
                ...
                patientRepos.save(new Patient(null, "20aea85d-a696-499f-a3ed-24d838562001", "Susanna", "Uthaug", "Female", new Date("1946/05/30"), "patient.susanna.uthaug@example.com", "48218033", null, "https://randomuser.me/api/portraits/women/27.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser8")) {
                ...
                patientRepos.save(new Patient(null, "281400a7-876c-4e06-a90a-6d16388929fd", "Daisy", "Little", "Female", new Date("1989/09/12"), "patient.daisy.little@example.com", "0465-431-472", null, "https://randomuser.me/api/portraits/women/13.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser9")) {
                ...
                patientRepos.save(new Patient(null, "ca06cbe0-6d40-4f35-956f-29e07b45c575", "Brittany", "Gibson", "Female", new Date("1969/09/07"), "patient.brittany.gibson@example.com", "081-552-4119", null, "https://randomuser.me/api/portraits/women/39.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser10")) {
                ...
                patientRepos.save(new Patient(null, "a371c311-1cae-4295-a9e8-719b591c8d41", "Hunter", "Bélanger", "Male", new Date("1983/08/30"), "patient.hunter.belanger@example.com", "B59 P15-7658", null, "https://randomuser.me/api/portraits/men/43.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser11")) {
                ...
                patientRepos.save(new Patient(null, "7b02f9df-1175-4dae-9cdc-57414e182e8f", "Lilje", "Smith", "Female", new Date("1993/01/30"), "patient.lilje.smith@example.com", "92440993", null, "https://randomuser.me/api/portraits/women/84.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser12")) {
                ...
                patientRepos.save(new Patient(null, "38c2039e-9079-4b6f-847e-600b14534b68", "Finn", "Wang", "Male", new Date("1957/06/21"), "patient.finn.wang@example.com", "41191647", null, "https://randomuser.me/api/portraits/men/34.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser13")) {
                ...
                patientRepos.save(new Patient(null, "e657e485-bdd5-4fb4-bc90-5233d6f9b029", "Marilou", "Mackay", "Female", new Date("1996/08/12"), "patient.marilou.mackay@example.com", "P42 A28-6638", null, "https://randomuser.me/api/portraits/women/43.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser14")) {
                ...
                patientRepos.save(new Patient(null, "fcead67e-e549-441f-8ef2-d75d6ce25893", "Bernice", "Green", "Female", new Date("1966/02/19"), "patient.bernice.green@example.com", "0474-436-613", null, "https://randomuser.me/api/portraits/women/8.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser15")) {
                ...
                patientRepos.save(new Patient(null, "f64be84d-e821-4c80-a385-f2fd06792248", "Neil", "Perry", "Male", new Date("1975/10/20"), "patient.neil.perry@example.com", "(707) 695-9623", null, "https://randomuser.me/api/portraits/men/98.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser16")) {
                ...
                patientRepos.save(new Patient(null, "902838d1-bbca-49d5-b3a7-85dee99b8c15", "Sophie", "Patel", "Female", new Date("1971/09/27"), "patient.sophie.patel@example.com", "Q09 I09-2137", null, "https://randomuser.me/api/portraits/women/52.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser17")) {
                ...
                patientRepos.save(new Patient(null, "49735c9d-3384-42aa-ad62-034877ee3123", "Annie", "Lawrence", "Female", new Date("1992/08/29"), "patient.annie.lawrence@example.com", "0443-235-517", null, "https://randomuser.me/api/portraits/women/42.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser18")) {
                ...
                patientRepos.save(new Patient(null, "1d155b9c-f38e-4cae-bb2f-ee98b27b21ee", "Jacob", "Rose", "Male", new Date("1957/11/08"), "patient.jacob.rose@example.com", "(523) 928-5733", null, "https://randomuser.me/api/portraits/men/56.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser19")) {
                ...
                patientRepos.save(new Patient(null, "d77d7ece-26f5-4623-a23a-86527c35fbd9", "Ron", "Brown", "Male", new Date("1993/01/19"), "patient.ron.brown@example.com", "081-159-6496", null, "https://randomuser.me/api/portraits/men/59.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser20")) {
                ...
                patientRepos.save(new Patient(null, "c3f4e257-2b9c-4e6a-8c6d-df7721831075", "Malone", "Leroy", "Male", new Date("1986/03/27"), "patient.malone.leroy@example.com", "06-97-68-05-71", null, "https://randomuser.me/api/portraits/men/8.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser21")) {
                ...
                patientRepos.save(new Patient(null, "a17e6e40-9d02-4c88-8622-f49595907062", "Millian", "Horten", "Male", new Date("1978/11/04"), "patient.millian.horten@example.com", "99927158", null, "https://randomuser.me/api/portraits/men/76.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser22")) {
                ...
                patientRepos.save(new Patient(null, "5ee9ddfc-1dd9-410c-9bbd-96e4f5ab6960", "Cilly", "Kehl", "Female", new Date("1979/06/29"), "patient.cilly.kehl@example.com", "0179-1321599", null, "https://randomuser.me/api/portraits/women/5.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser23")) {
                ...
                patientRepos.save(new Patient(null, "0e1e409f-928c-498d-abee-5bc46da77c22", "Isabelle", "Woods", "Female", new Date("1949/04/12"), "patient.isabelle.woods@example.com", "081-991-2828", null, "https://randomuser.me/api/portraits/women/69.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser24")) {
                ...
                patientRepos.save(new Patient(null, "32060388-ef07-4bdd-aacc-c496e56efee5", "Emile", "Roy", "Male", new Date("1995/07/18"), "patient.emile.roy@example.com", "L63 X97-2798", null, "https://randomuser.me/api/portraits/men/34.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser25")) {
                ...
                patientRepos.save(new Patient(null, "6a8cbe96-ebfa-4fa7-a03d-5f894f4ba25b", "Melanie", "West", "Female", new Date("1969/08/09"), "patient.melanie.west@example.com", "0460-419-045", null, "https://randomuser.me/api/portraits/women/9.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser26")) {
                ...
                patientRepos.save(new Patient(null, "ad4fa097-6293-4770-bf5d-e414e6a6a673", "Wolf-Rüdiger", "Guhl", "Male", new Date("1985/05/09"), "patient.wolf-rudiger.guhl@example.com", "0174-5827848", null, "https://randomuser.me/api/portraits/men/0.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser27")) {
                ...
                patientRepos.save(new Patient(null, "bdaa3c7d-46f0-4a48-b753-f5f6f2aa2c01", "Mary", "Berry", "Female", new Date("1954/06/07"), "patient.mary.berry@example.com", "0472-557-191", null, "https://randomuser.me/api/portraits/women/52.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser28")) {
                ...
                patientRepos.save(new Patient(null, "2b7b1e8c-c97d-4fb7-b5f4-0489f41e0ddf", "Marilou", "Grewal", "Female", new Date("2000/08/19"), "patient.marilou.grewal@example.com", "F09 Z76-2270", null, "https://randomuser.me/api/portraits/women/64.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser29")) {
                ...
                patientRepos.save(new Patient(null, "a2a25ea7-7a89-4b4f-88e9-6304da95c3be", "Philip", "Addy", "Male", new Date("1976/04/12"), "patient.philip.addy@example.com", "I11 I75-4819", null, "https://randomuser.me/api/portraits/men/60.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser30")) {
                ...
                patientRepos.save(new Patient(null, "d74e2b12-0063-4610-90db-968b5171ab17", "Marilyn", "Lee", "Female", new Date("1993/12/26"), "patient.marilyn.lee@example.com", "(585) 857-2702", null, "https://randomuser.me/api/portraits/women/48.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser31")) {
                ...
                patientRepos.save(new Patient(null, "dcc5e046-4e6f-4ead-9184-d5ce314f47b4", "Misty", "Turner", "Female", new Date("1970/12/27"), "patient.misty.turner@example.com", "(483) 988-4482", null, "https://randomuser.me/api/portraits/women/84.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser32")) {
                ...
                patientRepos.save(new Patient(null, "2cf4a4ad-4cd3-4f3f-a02f-7eaff4a6ee1c", "Linus", "Holmedal", "Male", new Date("1962/06/29"), "patient.linus.holmedal@example.com", "49791105", null, "https://randomuser.me/api/portraits/men/88.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser33")) {
                ...
                patientRepos.save(new Patient(null, "6faca893-f73b-4940-853d-5766354dbd04", "Gabriel", "Chan", "Male", new Date("1953/05/21"), "patient.gabriel.chan@example.com", "J65 P10-1073", null, "https://randomuser.me/api/portraits/men/43.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser34")) {
                ...
                patientRepos.save(new Patient(null, "f84cc184-04c3-4315-b326-4374a4d61f04", "Dursun", "Balzer", "Male", new Date("1969/12/23"), "patient.dursun.balzer@example.com", "0172-4703854", null, "https://randomuser.me/api/portraits/men/71.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser35")) {
                ...
                patientRepos.save(new Patient(null, "15363b59-3949-4f2e-b63b-b56f99c74e96", "Connor", "Steward", "Male", new Date("1953/03/08"), "patient.connor.steward@example.com", "0494-015-879", null, "https://randomuser.me/api/portraits/men/93.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser36")) {
                ...
                patientRepos.save(new Patient(null, "f9ce0bbb-1c66-45a9-a581-bdee3514a3bb", "Alexander", "King", "Male", new Date("1978/04/27"), "patient.alexander.king@example.com", "(513) 441-5821", null, "https://randomuser.me/api/portraits/men/1.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser37")) {
                ...
                patientRepos.save(new Patient(null, "60acbb20-c3ec-4698-a4d4-f1128181fe5a", "Minnie", "Thompson", "Female", new Date("1960/09/06"), "patient.minnie.thompson@example.com", "(346) 864-6217", null, "https://randomuser.me/api/portraits/women/76.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser38")) {
                ...
                patientRepos.save(new Patient(null, "3595cb1b-9f9f-4a36-acd2-003099afb729", "Rawan", "Sirevåg", "Female", new Date("1978/08/16"), "patient.rawan.sirevag@example.com", "98440791", null, "https://randomuser.me/api/portraits/women/56.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser39")) {
                ...
                patientRepos.save(new Patient(null, "42d6af6d-66ab-4ae2-bd58-637871867c64", "Miriam", "Payne", "Female", new Date("1949/03/20"), "patient.miriam.payne@example.com", "0469-481-411", null, "https://randomuser.me/api/portraits/women/46.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser40")) {
                ...
                patientRepos.save(new Patient(null, "e16a0f50-f416-4ce8-ab72-461b2b956728", "Oscar", "Da Silva", "Male", new Date("1971/03/11"), "patient.oscar.dasilva@example.com", "06-50-04-94-20", null, "https://randomuser.me/api/portraits/men/61.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser41")) {
                ...
                patientRepos.save(new Patient(null, "fe59c2f5-38ea-47e4-9428-3f4934e33d92", "Cord", "Fellner", "Male", new Date("1945/02/11"), "patient.cord.fellner@example.com", "0178-6476262", null, "https://randomuser.me/api/portraits/men/27.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser42")) {
                ...
                patientRepos.save(new Patient(null, "c5977f7a-4676-428b-85aa-e841d9a8cedb", "Gerlind", "Ackermann", "Female", new Date("1988/11/22"), "patient.gerlind.ackermann@example.com", "0177-6933267", null, "https://randomuser.me/api/portraits/women/13.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser43")) {
                ...
                patientRepos.save(new Patient(null, "b2350e8f-32be-4183-8d82-2df2ffcffcb1", "Dylan", "Slawa", "Male", new Date("1963/12/31"), "patient.dylan.slawa@example.com", "D60 Z06-8046", null, "https://randomuser.me/api/portraits/men/53.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser44")) {
                ...
                patientRepos.save(new Patient(null, "a51c717a-cd66-4bda-a4ff-687436882c21", "Chantal", "Dahmen", "Female", new Date("1962/11/26"), "patient.chantal.dahmen@example.com", "0174-4217977", null, "https://randomuser.me/api/portraits/women/29.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser45")) {
                ...
                patientRepos.save(new Patient(null, "72fdb4a7-7c70-4227-9ef2-49830754a4a8", "Linda", "Bøhler", "Female", new Date("1952/08/26"), "patient.linda.bohler@example.com", "49860351", null, "https://randomuser.me/api/portraits/women/35.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser46")) {
                ...
                patientRepos.save(new Patient(null, "19993b9c-3c51-44c7-9163-5f3e8c5579b2", "Nanna", "Brunstad", "Female", new Date("1989/05/07"), "patient.nanna.brunstad@example.com", "47781791", null, "https://randomuser.me/api/portraits/women/23.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser47")) {
                ...
                patientRepos.save(new Patient(null, "32934d1c-957a-4a68-b875-349e9b3846f7", "Hubertus", "Meiser", "Male", new Date("1995/12/10"), "patient.hubertus.meiser@example.com", "0171-4214218", null, "https://randomuser.me/api/portraits/men/6.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser48")) {
                ...
                patientRepos.save(new Patient(null, "8d0913fd-ce1f-419e-b7fb-0bd2bc1e699c", "Henri", "Fey", "Male", new Date("1999/08/16"), "patient.henri.fey@example.com", "0174-9880827", null, "https://randomuser.me/api/portraits/men/40.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser49")) {
                ...
                patientRepos.save(new Patient(null, "e1ca213a-9f4d-4d17-8685-37449b51e409", "Viola", "Ryeng", "Female", new Date("1967/01/28"), "patient.viola.ryeng@example.com", "95054912", null, "https://randomuser.me/api/portraits/women/89.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser50")) {
                ...
                patientRepos.save(new Patient(null, "a4dfbad1-8c23-4e50-b15b-54a51de32d03", "Abigail", "Carlson", "Female", new Date("1980/03/17"), "patient.abigail.carlson@example.com", "081-820-3504", null, "https://randomuser.me/api/portraits/women/39.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser51")) {
                ...
                patientRepos.save(new Patient(null, "d82199d8-c450-4906-aa93-c8797ac62ffe", "Roland", "Davis", "Male", new Date("1978/06/19"), "patient.roland.davis@example.com", "0435-399-288", null, "https://randomuser.me/api/portraits/men/30.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser52")) {
                ...
                patientRepos.save(new Patient(null, "39d721b2-606c-4c92-9a00-35ddacf5bd83", "Magnus", "Pelzer", "Male", new Date("1974/03/20"), "patient.magnus.pelzer@example.com", "0176-7210291", null, "https://randomuser.me/api/portraits/men/96.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser53")) {
                ...
                patientRepos.save(new Patient(null, "229d9707-3db4-4136-94e1-5429efbfd2f6", "Karen", "Smythe", "Female", new Date("1970/11/17"), "patient.karen.smythe@example.com", "081-126-8649", null, "https://randomuser.me/api/portraits/women/75.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser54")) {
                ...
                patientRepos.save(new Patient(null, "19033660-3c3b-4a0a-8568-76b70fda11b8", "Rene", "Chapman", "Male", new Date("1997/08/14"), "patient.rene.chapman@example.com", "0448-482-132", null, "https://randomuser.me/api/portraits/men/99.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser55")) {
                ...
                patientRepos.save(new Patient(null, "c59ecff1-4d3d-4ca9-a0bd-934c567ec44f", "Claire", "Lopez", "Female", new Date("2001/03/16"), "patient.claire.lopez@example.com", "(790) 766-9952", null, "https://randomuser.me/api/portraits/women/93.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser56")) {
                ...
                patientRepos.save(new Patient(null, "c0ab658d-8d13-4f0d-86e3-5294241d5977", "Jimmy", "Collins", "Male", new Date("1981/08/01"), "patient.jimmy.collins@example.com", "(914) 582-8906", null, "https://randomuser.me/api/portraits/men/18.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser57")) {
                ...
                patientRepos.save(new Patient(null, "eeb4bfd6-6c78-4c1e-98b5-ec4bbafb2981", "Gaspard", "Guillot", "Male", new Date("1962/09/03"), "patient.gaspard.guillot@example.com", "06-01-52-31-63", null, "https://randomuser.me/api/portraits/men/70.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser58")) {
                ...
                patientRepos.save(new Patient(null, "2e5042f1-9e49-48a5-a26e-a47b1ba78d63", "Mélody", "Robin", "Female", new Date("1973/06/25"), "patient.melody.robin@example.com", "06-83-90-00-28", null, "https://randomuser.me/api/portraits/women/79.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser59")) {
                ...
                patientRepos.save(new Patient(null, "b162f178-a8ee-44cc-a3a1-1f4ef05f7546", "Imke", "Wüst", "Female", new Date("1969/06/26"), "patient.imke.wust@example.com", "0172-9603291", null, "https://randomuser.me/api/portraits/women/93.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser60")) {
                ...
                patientRepos.save(new Patient(null, "3765ffca-6578-48ce-8bf0-e4b6c7f8c079", "Tristan", "Le Gall", "Male", new Date("1982/05/30"), "patient.tristan.legall@example.com", "06-19-67-94-78", null, "https://randomuser.me/api/portraits/men/9.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser61")) {
                ...
                patientRepos.save(new Patient(null, "be7efecc-ea16-4099-b978-c07c52a70b58", "Guntram", "Eisele", "Male", new Date("1976/09/06"), "patient.guntram.eisele@example.com", "0172-7050111", null, "https://randomuser.me/api/portraits/men/6.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser62")) {
                ...
                patientRepos.save(new Patient(null, "d863b32c-8e6e-46e2-a02b-488b2f290faf", "Delphine", "Macdonald", "Female", new Date("1978/06/04"), "patient.delphine.macdonald@example.com", "Q02 E27-0624", null, "https://randomuser.me/api/portraits/women/15.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser63")) {
                ...
                patientRepos.save(new Patient(null, "c777ac60-4dfb-4405-9092-b9898c7c8c9b", "Flora", "Blanc", "Female", new Date("1965/07/30"), "patient.flora.blanc@example.com", "06-35-32-34-10", null, "https://randomuser.me/api/portraits/women/70.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser64")) {
                ...
                patientRepos.save(new Patient(null, "8dfda131-43c0-483e-b0ff-c934c14f0ebd", "Alicia", "Taylor", "Female", new Date("1999/09/09"), "patient.alicia.taylor@example.com", "(747) 858-5966", null, "https://randomuser.me/api/portraits/women/84.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser65")) {
                ...
                patientRepos.save(new Patient(null, "2ecb3990-d1e9-4ddc-9703-698426a71b7d", "Megan", "Taylor", "Female", new Date("1956/10/10"), "patient.megan.taylor@example.com", "G23 E67-0565", null, "https://randomuser.me/api/portraits/women/62.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser66")) {
                ...
                patientRepos.save(new Patient(null, "304e1fc4-9af4-427d-a4a2-da88979a1cc6", "Lothar", "Munz", "Male", new Date("1990/10/14"), "patient.lothar.munz@example.com", "0174-3126223", null, "https://randomuser.me/api/portraits/men/84.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser67")) {
                ...
                patientRepos.save(new Patient(null, "3a96e9f4-200a-4b58-b992-a5d0d5987f9c", "Constance", "Weaver", "Female", new Date("1963/09/12"), "patient.constance.weaver@example.com", "0408-089-346", null, "https://randomuser.me/api/portraits/women/61.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser68")) {
                ...
                patientRepos.save(new Patient(null, "22176443-2bda-4988-9d13-eb4eced52740", "Ken", "Kelley", "Male", new Date("1968/04/02"), "patient.ken.kelley@example.com", "(834) 914-6024", null, "https://randomuser.me/api/portraits/men/29.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser69")) {
                ...
                patientRepos.save(new Patient(null, "51647f66-8682-4121-b2de-3be62601e68a", "Kristina", "Hofmeister", "Female", new Date("1995/11/29"), "patient.kristina.hofmeister@example.com", "0177-5549834", null, "https://randomuser.me/api/portraits/women/26.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser70")) {
                ...
                patientRepos.save(new Patient(null, "d57a1ea5-af43-42ff-a0ea-3d985c0ef240", "Phil", "Omahony", "Male", new Date("1958/10/14"), "patient.phil.omahony@example.com", "081-673-1800", null, "https://randomuser.me/api/portraits/men/84.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser71")) {
                ...
                patientRepos.save(new Patient(null, "ef9cccfb-bdbd-476d-ade8-d8e947eb1938", "Danielle", "Jones", "Female", new Date("1990/07/24"), "patient.danielle.jones@example.com", "081-478-5663", null, "https://randomuser.me/api/portraits/women/66.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser72")) {
                ...
                patientRepos.save(new Patient(null, "5225c96d-2ebd-4af8-a39b-77c8a8d6b152", "Hasan", "Sundal", "Male", new Date("1992/07/15"), "patient.hasan.sundal@example.com", "96906675", null, "https://randomuser.me/api/portraits/men/5.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser73")) {
                ...
                patientRepos.save(new Patient(null, "f68371aa-1fea-4fca-a651-233ba09d8a1a", "Fredi", "Eichinger", "Male", new Date("1988/01/06"), "patient.fredi.eichinger@example.com", "0171-3181590", null, "https://randomuser.me/api/portraits/men/58.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser74")) {
                ...
                patientRepos.save(new Patient(null, "3f41ba1d-365e-4b75-a76b-7ad149736f31", "Travis", "Schmidt", "Male", new Date("1969/06/02"), "patient.travis.schmidt@example.com", "0454-591-705", null, "https://randomuser.me/api/portraits/men/91.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser75")) {
                ...
                patientRepos.save(new Patient(null, "b453ae65-1cce-41e8-8ca0-646745a13f56", "Victoria", "Li", "Female", new Date("1985/09/24"), "patient.victoria.li@example.com", "I89 D80-8294", null, "https://randomuser.me/api/portraits/women/30.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser76")) {
                ...
                patientRepos.save(new Patient(null, "853c3544-a934-4975-95d5-2281b6b5f826", "Maëlys", "Bernard", "Female", new Date("1988/10/08"), "patient.maelys.bernard@example.com", "06-01-29-19-97", null, "https://randomuser.me/api/portraits/women/5.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser77")) {
                ...
                patientRepos.save(new Patient(null, "a8a8d735-7f9a-4267-8f1d-d87e45205125", "Christopher", "Wik", "Male", new Date("1949/02/23"), "patient.christopher.wik@example.com", "44166150", null, "https://randomuser.me/api/portraits/men/16.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser78")) {
                ...
                patientRepos.save(new Patient(null, "f201b1c7-4fd8-40d7-9962-975cc1049cbf", "Lidwina", "Holzwarth", "Female", new Date("1949/12/21"), "patient.lidwina.holzwarth@example.com", "0170-8613935", null, "https://randomuser.me/api/portraits/women/51.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser79")) {
                ...
                patientRepos.save(new Patient(null, "512ef393-5b83-4e6a-bc96-014692797579", "Willie", "Barrett", "Male", new Date("1978/08/21"), "patient.willie.barrett@example.com", "(915) 254-7881", null, "https://randomuser.me/api/portraits/men/66.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser80")) {
                ...
                patientRepos.save(new Patient(null, "3f6c11fa-25f2-4435-ae32-bc7be9ded9e2", "Sakarias", "Silva", "Male", new Date("1996/01/25"), "patient.sakarias.silva@example.com", "91443840", null, "https://randomuser.me/api/portraits/men/6.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser81")) {
                ...
                patientRepos.save(new Patient(null, "0e0ac936-370d-41c4-ae51-03c80a7b95b5", "Adèle", "Roche", "Female", new Date("1960/03/28"), "patient.adele.roche@example.com", "06-05-22-55-15", null, "https://randomuser.me/api/portraits/women/92.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser82")) {
                ...
                patientRepos.save(new Patient(null, "a9fa8672-67cc-423b-bbcc-6841b2c8d6cd", "Mary", "Ross", "Female", new Date("1979/06/25"), "patient.mary.ross@example.com", "081-181-2181", null, "https://randomuser.me/api/portraits/women/62.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser83")) {
                ...
                patientRepos.save(new Patient(null, "d984e5d6-fe38-477d-8c8c-3b036f89e2f4", "Christian", "Østvik", "Male", new Date("1979/09/02"), "patient.christian.ostvik@example.com", "40705144", null, "https://randomuser.me/api/portraits/men/55.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser84")) {
                ...
                patientRepos.save(new Patient(null, "8be94aad-5ff8-47bf-a817-5342706dc583", "Thomas", "Lo", "Male", new Date("1981/09/11"), "patient.thomas.lo@example.com", "R53 B97-3374", null, "https://randomuser.me/api/portraits/men/24.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser85")) {
                ...
                patientRepos.save(new Patient(null, "de23906a-6d34-4d5f-9d76-e396abf1a795", "Emma", "Harcourt", "Female", new Date("1982/03/13"), "patient.emma.harcourt@example.com", "S64 A02-5000", null, "https://randomuser.me/api/portraits/women/23.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser86")) {
                ...
                patientRepos.save(new Patient(null, "50491eb4-2b7e-45a4-9e05-2e1f7ce8057e", "Willy", "Rist", "Male", new Date("1948/05/05"), "patient.willy.rist@example.com", "0177-7135781", null, "https://randomuser.me/api/portraits/men/57.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser87")) {
                ...
                patientRepos.save(new Patient(null, "18aab23e-bf31-4180-8816-2e0478934877", "Willibald", "Richter", "Male", new Date("1987/12/22"), "patient.willibald.richter@example.com", "0170-4024254", null, "https://randomuser.me/api/portraits/men/43.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser88")) {
                ...
                patientRepos.save(new Patient(null, "63520c97-3bd1-4692-96fd-5e4679596999", "Jim", "Jordan", "Male", new Date("1971/09/27"), "patient.jim.jordan@example.com", "081-947-2958", null, "https://randomuser.me/api/portraits/men/92.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser89")) {
                ...
                patientRepos.save(new Patient(null, "31c5f0a5-e171-4965-8858-f6936e121034", "Alexandre", "Jean-Baptiste", "Male", new Date("1984/09/08"), "patient.alexandre.jean-baptiste@example.com", "Y63 B45-5504", null, "https://randomuser.me/api/portraits/men/5.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser90")) {
                ...
                patientRepos.save(new Patient(null, "30062a06-9156-438d-b47b-957f6e8b465b", "Arnold", "Wagner", "Male", new Date("1960/01/31"), "patient.arnold.wagner@example.com", "0423-858-116", null, "https://randomuser.me/api/portraits/men/55.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser91")) {
                ...
                patientRepos.save(new Patient(null, "941e4871-9e57-402e-8f31-b882b31730a6", "Logan", "Bergeron", "Male", new Date("1959/09/14"), "patient.logan.bergeron@example.com", "K19 W14-1389", null, "https://randomuser.me/api/portraits/men/13.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser92")) {
                ...
                patientRepos.save(new Patient(null, "64c59e3c-04b8-4d62-aae2-575d74ba5ffd", "Baldur", "Henrichs", "Male", new Date("1982/03/27"), "patient.baldur.henrichs@example.com", "0173-3846315", null, "https://randomuser.me/api/portraits/men/47.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser93")) {
                ...
                patientRepos.save(new Patient(null, "5ce47b16-d874-4beb-93dd-705784c000f5", "Wesley", "Austin", "Male", new Date("1991/10/18"), "patient.wesley.austin@example.com", "081-170-9645", null, "https://randomuser.me/api/portraits/men/0.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser94")) {
                ...
                patientRepos.save(new Patient(null, "2256d540-2ee5-429e-a949-86e07f7028db", "Sigurd", "Frøseth", "Male", new Date("1994/02/06"), "patient.sigurd.froseth@example.com", "41810850", null, "https://randomuser.me/api/portraits/men/5.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser95")) {
                ...
                patientRepos.save(new Patient(null, "28263aec-5a70-476f-a1ee-1909c0db5bce", "Judy", "Fox", "Female", new Date("1972/08/09"), "patient.judy.fox@example.com", "081-969-1497", null, "https://randomuser.me/api/portraits/women/18.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser96")) {
                ...
                patientRepos.save(new Patient(null, "31c888f9-30a4-4236-86be-b6354728d324", "Irma", "Eilers", "Female", new Date("1992/02/01"), "patient.irma.eilers@example.com", "0175-5061620", null, "https://randomuser.me/api/portraits/women/83.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser97")) {
                ...
                patientRepos.save(new Patient(null, "d469a8bc-be22-45bb-ac90-90c4ad580558", "Paige", "Horton", "Female", new Date("1956/07/12"), "patient.paige.horton@example.com", "081-936-6958", null, "https://randomuser.me/api/portraits/women/67.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser98")) {
                ...
                patientRepos.save(new Patient(null, "bee9d44c-2580-4269-9222-7bda7a41b019", "Erica", "Adams", "Female", new Date("1950/01/01"), "patient.erica.adams@example.com", "(561) 248-9303", null, "https://randomuser.me/api/portraits/women/86.jpg", patientAddress, false, patientUser, null));
            }
            ...
            if(!userRepos.existsByUsername("patientuser99")) {
                ...
                patientRepos.save(new Patient(null, "0bae68cb-f0ac-4415-9a27-447a3974ac77", "Annabelle", "Macdonald", "Female", new Date("1993/01/15"), "patient.annabelle.macdonald@example.com", "V83 I41-3514", null, "https://randomuser.me/api/portraits/women/21.jpg", patientAddress, false, patientUser, null));
            }
