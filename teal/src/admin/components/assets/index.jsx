...
import { axiosAction, numberSort, stringSort, notify, axiosActions } from "../../../actions";
...
class Assets extends Component {
  ...
  deleteData() {
    const deleteReq = {
      url: "/assets/" + this.state.selectId,
      method: DELETE,
      callback: (res) => {
        ...
        render: (text, record) => (
          <div className="dropdown dropdown-action">
            ...
            <div className="dropdown-menu dropdown-menu-right">
              ...
              <a className="dropdown-item" onClick={() => this.setState({selectId: record.id})} href="#" data-toggle="modal" data-target="#delete_asset"><i className="fas fa-trash m-r-5" /> Delete</a>
            </div>
          </div>
        ),
      },
