                ...
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      ...
                      <input name="email" className={isValid(this.state.data.employee.email && validReg(this.state.data.employee.email, "email"))} type="email" onChange={this.onChange} />
                  ...
                  <div className="col-sm-6">
                    <div className="form-group">
                      <label>Phone </label>
                      <input name="phone" className={isValid(this.state.data.employee.phoneNumber && validReg(this.state.data.employee.phoneNumber, "phone"))} type="tel" onChange={this.onChange} />
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-6">
                        <div className="form-group">
                          ...
                          <input name="district" type="text" className={isValid(this.state.data.employee.address?.district)} onChange={this.onChange} />
