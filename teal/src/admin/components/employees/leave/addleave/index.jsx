...
import { ADD, GET, leave_status, leave_type } from '../../../../../constants';
                                    ...
                                    <>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="m-t-20 text-center">
                                                <button className="btn btn-primary submit-btn">Create Leave Request</button>
