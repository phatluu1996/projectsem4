...
import { Doctor_thumb_03,User_img,Doctor_03,Attachment } from "../../imagepath";
                      ...
                      <div className="navbar">
                        <div className="user-details mr-auto">
                          <div className="float-left user-img m-r-10">
                            <Link to="/profile" title="Jennifer Robinson"><img src={User_img} alt="" className="w-40 rounded-circle" /><span className="status online" /></Link>
                          </div>
                          <div className="user-info float-left">
                            <Link to="/profile" title="Jennifer Robinson"><span className="font-bold">Jennifer Robinson</span></Link>
                    ...
                    <div className="chat-contents">
                      <div className="chat-content-wrap">
                        <div className="voice-call-avatar">
                          <img src={Doctor_03} alt="" className="call-avatar" />
                                          ...
                                          <div className="chat-content">
                                            ...
                                            <ul className="attach-list">
                                              <li className="img-file">
                                                ...
                                                <div className="task-attach-img"><img src={Doctor_thumb_03} alt="" /></div>
                                              </li>
                                            </ul>
                                          </div>
                                        </div>
